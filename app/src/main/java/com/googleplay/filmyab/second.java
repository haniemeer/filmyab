...
public class second extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringRequst request = new StringRequst(Request.Method.GET, Ur, )
        try {
            ...
            Picasso.with(second.this).load("https://api.themoviedb.org/t/p/w600_and_h900_bestv2" + jsonObject.getString());
    ...
    private class StringRequst {
        public StringRequst(int get, String ur, Object p2) {
        }
    }
